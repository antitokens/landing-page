    ...
    <footer class="border-t border-gray-800/50 backdrop-blur-xl bg-dark-card/95 w-full">
        <div class="max-w-7xl mx-auto px-4 py-12">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                <div class="space-y-4">
                    <img src="/assets/antitoken_logo_small.webp" alt="Antitoken Logo" class="h-12 w-auto rounded-full border border-gray-800/50 border-2">
                ...
                <div>
                    ...
                    <div class="space-y-2">
                        <a href="https://lite.antitoken.pro" target="_blank" class="block text-gray-400 hover:text-accent-primary transition-colors">Prediction</a>
                        <a href="#benefits" class="block text-gray-400 hover:text-accent-primary transition-colors">Features</a>
                ...
                <div>
                    ...
                    <div class="space-y-2">
                        ...
                        <a href="https://t.me/antitokengroup" target="_blank" class="flex items-center gap-2 block text-gray-400 hover:text-accent-primary transition-colors">
                        ...
                        <a href="https://forum.antitoken.pro" target="_blank" class="flex items-center gap-2 block text-gray-400 hover:text-accent-primary transition-colors">
...
customElements.define('antitoken-footer', Footer);
