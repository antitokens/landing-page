         ...
         <div class="nav-links hidden md:flex justify-center space-x-8">
            ...
            <div class="relative">
               ...
               <div class="absolute hidden w-48 bg-dark-card/90 border border-gray-800/50 rounded-lg mt-2" id="desktop-technology-content">
                  <a href="https://docs.antitoken.pro/docs/whitepaper/antitoken" target="_blank", class="items-center flex px-4 py-2 text-gray-300 hover:text-accent-primary hover:bg-gray-800/30">
                     <svg
                        class="mr-2"
                  ...
                  <a href="https://docs.antitoken.pro/docs/yellowpaper/antitoken" target="_blank" class="items-center flex px-4 py-2 text-gray-300 hover:text-accent-primary hover:bg-gray-800/30">
                     <svg
                        class="mr-2"
                        xmlns="http://www.w3.org/2000/svg"
                        width="18"
                  ...
                  <a href="https://docs.antitoken.pro/" target="_blank" class="items-center flex px-4 py-2 text-gray-300 hover:text-accent-primary hover:bg-gray-800/30">
                     <svg
                        class="mr-2"
                        xmlns="http://www.w3.org/2000/svg"
                        width="18"
            ...
            <div class="relative">
               ...
               <div class="absolute hidden w-48 bg-dark-card/90 border border-gray-800/50 rounded-lg mt-2" id="desktop-community-content">
                  ...
                  <a href="https://forum.antitoken.pro" target="_blank" class="items-center flex px-4 py-2 text-gray-300 hover:text-accent-primary hover:bg-gray-800/30">
                     <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="18" height="18" fill="#d6d6d6">
            ...
            <div class="relative">
               ...
               <div class="absolute hidden w-48 bg-dark-card/90 border border-gray-800/50 rounded-lg mt-2" id="desktop-apps-content">
                  <a href="https://poll.antitoken.pro/" target="_blank" class="items-center flex px-4 py-2 text-gray-300 hover:text-accent-primary hover:bg-gray-800/30">
                     <svg
                        class="mr-2"
                        xmlns="http://www.w3.org/2000/svg"
                        width="18"
                  ...
                  <a href="https://lite.antitoken.pro/" class="items-center flex px-4 py-2 text-gray-300 hover:text-accent-primary hover:bg-gray-800/30">
                     <svg
                        class="mr-2"
                        xmlns="http://www.w3.org/2000/svg"
                        width="18"
                  ...
                  <a href="https://app.antitoken.pro/" class="items-center flex px-4 py-2 text-gray-300 hover:text-accent-primary hover:bg-gray-800/30">
                     <svg
                        class="mr-2"
                        xmlns="http://www.w3.org/2000/svg"
                        width="18"
      ...
      <div class="px-4 py-3 space-y-4 bg-dark-card/90 border-b border-gray-800/50">
         <div class="space-y-2">
            ...
            <div class="space-y-2 pl-4 border-l border-gray-700 hidden" id="mobile-technology-content">
               <a href="https://docs.antitoken.pro/docs/whitepaper/antitoken" target="_blank" class="flex text-gray-300 hover:text-accent-primary transition-colors">
               ...
               <a href="https://docs.antitoken.pro/docs/yellowpaper/antitoken" target="_blank" class="flex text-gray-300 hover:text-accent-primary transition-colors">
               ...
               <a href="https://docs.antitoken.pro/" target="_blank" class="flex text-gray-300 hover:text-accent-primary transition-colors">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                     <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5.35709 16V5.78571c0-.43393.34822-.78571.77777-.78571H18.5793c.4296 0 .7778.35178.7778.78571V16M5.35709 16h-1c-.55229 0-1 .4477-1 1v1c0 .5523.44771 1 1 1H20.3571c.5523 0 1-.4477 1-1v-1c0-.5523-.4477-1-1-1h-1M5.35709 16H19.3571M9.35709 8l2.62501 2.5L9.35709 13m4.00001 0h2"/>
                  </svg>
                  &nbsp;
